...
<div class="row">
    {{-- <div class="col-lg-12">
            <label class="my-2">{{ $label ?? 'Image' }}</label>
    </div> --}}
    <label class="fs-6 fw-bold form-label mt-3">
        <span class="required">{{ $label ?? 'Image' }}</span>
        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Image"></i>
    </label>
    <div class="col-lg-12">
        <div class="img-upload custom-image-upload">
            ...
            <label for="imageupload" class="img-label" id="image-label"><i class="fa fa-upload"></i>UPLOAD</label>
                <input accept="image/*" type='file' name="{{$name ?? 'image'}}" class="img-upload" id="imageupload">
            </div>
