                    ...
                    <div class="d-flex gap-5">
                        <form action="#" class="profile_form">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="fullname" value="{{ Auth::guard('users')->user()->name }}">
                            </div>
                            <div class="mb-3">
                                <label for="email" class="form-label">Email</label>
                                <input type="email" class="form-control" id="email" value="{{ Auth::guard('users')->user()->email }}">
                            </div>
                            <div class="mb-3">
                                <label for="phone" class="form-label">Nomor Telepon</label>
                                <input type="phone" class="form-control" id="phone" value="{{ Auth::guard('users')->user()->phone }}">
                            </div>
                            <button class="btn_profile mt-4" type="submit">Simpan Perubahan</button>
                        </form>
                        <div>
                            <input type="file" id="photo_profile" class="d-none">
                            <label for="photo_profile" class="profile_img2">
                                ...
                                <img src="{{ asset('/assets/frontend/images/icons/edit.svg') }}" class="img_edit" alt="">
                            </label>
                        </div>
                    </div>
                </div>
