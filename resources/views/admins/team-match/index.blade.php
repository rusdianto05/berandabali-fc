@extends('layouts.master', ['title' => 'Pertandingan Tim'])
@section('content')
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="#" class="text-muted text-hover-primary">Pertandingan Tim</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">List Pertandingan Tim</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                    ...
                    <div class="card-header d-flex align-items-center justify-content-end border-0 pt-6">
                        ...
                        <div class="">
                            <a type="a" class="btn btn-sm btn-primary" id="btn_add_permission"
                                href="{{ route('team-match.create') }}">+ Pertandingan</a>
                            <!--end::Primary button-->
                        </div>
                        <!--end::Card title-->
                    </div>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return `<img src="/${data}" alt="" width="150px" height="200px">`
                        }
                    },
                    {
                        data: 'opponent_name',
