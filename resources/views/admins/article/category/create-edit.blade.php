        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                {{-- <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('admin.index') }}" class="btn btn-sm btn-primary">Kembali</a>
                    <!--end::Primary button-->
                </div> --}}
                <!--end::Actions-->
            </div>
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="card card-flush h-lg-100" id="kt_contacts_main">
                            ...
                            <div class="card-body pt-5">
                                ...
                                <form
                                    action="{{ request()->routeIs('category-article.create') ? route('category-article.store') : route('category-article.update', @$categoryArticle->id) }}"
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <label class="fs-6 fw-bold form-label mt-3">
                                            ...
                                            <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                                title="Masukkan nama kategori artikel"></i>
                                        </label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid" name="name"
                                            value="{{ @$categoryArticle->name ?? old('name') }}" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Separator-->
