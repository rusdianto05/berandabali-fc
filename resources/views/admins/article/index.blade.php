            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center justify-content-end border-0 pt-6">
                        ...
                        <div class="">
                            <a type="a" class="btn btn-sm btn-primary" id="btn_add_permission"
                                href="{{ route('article.create') }}">+ Artikel</a>
                            <!--end::Primary button-->
                        </div>
                        <!--end::Card title-->
                    </div>
                    ...
                    <div class="card-body pt-0">
                        <!--begin::Table-->
                        <table id="table-article" class="table table-striped border rounded gy-5 gs-7">
                            <thead>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            return data ? $.parseHTML(data)[0].data : '-';
                        }
                    },
                    {
                        data: 'action',
