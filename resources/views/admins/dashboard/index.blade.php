                    ...
                    <div class="col-sm-6 col-xl-2 mb-xl-10">
                        ...
                        <div class="card h-lg-100">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                <!--begin::Icon-->
                                <div class="m-0">
                                    <img src="assets/media/svg/brand-logos/instagram-2-1.svg" class="w-35px"
                                        alt="" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Section-->
                    ...
                    <div class="col-sm-6 col-xl-2 mb-xl-10">
                        ...
                        <div class="card h-lg-100">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                <!--begin::Icon-->
                                <div class="m-0">
                                    <img src="assets/media/svg/brand-logos/facebook-3.svg" class="w-35px"
                                        alt="" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Section-->
                    ...
                    <div class="col-sm-6 col-xl-2 mb-xl-10">
                        ...
                        <div class="card h-lg-100">
                            ...
                            <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                <!--begin::Icon-->
                                <div class="m-0">
                                    <img src="assets/media/svg/brand-logos/dribbble-icon-1.svg" class="w-35px"
                                        alt="" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Section-->
                    ...
                    <div class="col-xl-4 mb-5 mb-xl-10">
                        ...
                        <div class="card card-flush border-0 h-lg-100" style="background-color: #7239EA">
                            ...
                            <div class="card-body d-flex justify-content-between flex-column pt-1 px-0 pb-0">
                                ...
                                <!--end::Wrapper-->
                                <!--begin::Chart-->
                                <div id="kt_card_widget_1_chart" data-kt-chart-color="#8F5FF4" style="height: 105px">
                                </div>
                                <!--end::Chart-->
                            </div>
                            <!--end::Body-->
                                    ...
                                    <div data-tns="true" data-tns-nav-position="bottom" data-tns-controls="false">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="m-0">
                                                    <span
                                                        class="text-gray-800 fw-bolder d-block fs-2hx lh-1 ls-n2">6.3k</span>
                                                ...
                                                <div
                                                    ...
                                                    <div class="mb-2">
                                                        <select
                                                            class="form-select form-select-transparent p-0 w-150px me-n5"
                                                    ...
                                                    <div class="progress h-6px w-100 bg-light">
                                                        <div class="progress-bar bg-warning" role="progressbar"
                                                            style="width: 65%" aria-valuemin="0" aria-valuemax="100">
                                                        </div>
                                                    </div>
                                                    <!--end::Progress-->
                                                </div>
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="m-0">
                                                    <span
                                                        class="text-gray-800 fw-bolder d-block fs-2hx lh-1 ls-n2">2.1k</span>
                                                    <span class="text-gray-400 fw-bold fs-6">Avarage
                                                        <br />Comments</span>
                                                </div>
                                                <!--end::Section-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="progress h-6px w-100 bg-light">
                                                        <div class="progress-bar bg-warning" role="progressbar"
                                                            style="width: 45%" aria-valuemin="0" aria-valuemax="100">
                                                        </div>
                                                    </div>
                                                    <!--end::Progress-->
                                                </div>
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="m-0">
                                                    <span
                                                        class="text-gray-800 fw-bolder d-block fs-2hx lh-1 ls-n2">650</span>
                                                    <span class="text-gray-400 fw-bold fs-6">Avarage
                                                        <br />Shares</span>
                                                </div>
                                                <!--end::Section-->
                                                ...
                                                <div
                                                    ...
                                                    <div class="progress h-6px w-100 bg-light">
                                                        <div class="progress-bar bg-warning" role="progressbar"
                                                            style="width: 85%" aria-valuemin="0" aria-valuemax="100">
                                                        </div>
                                                    </div>
                                                    <!--end::Progress-->
                                                </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="m-0">
                                                    <span
                                                        class="text-gray-800 fw-bolder d-block fs-2hx lh-1 ls-n2">3.4k</span>
                                                    <span class="text-gray-400 fw-bold fs-6">Avarage
                                                        <br />Comments</span>
                                                </div>
                                                <!--end::Section-->
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="m-0">
                                                    <span
                                                        class="text-gray-800 fw-bolder d-block fs-2hx lh-1 ls-n2">7.1k</span>
                                                    <span class="text-gray-400 fw-bold fs-6">Avarage
                                                        <br />Likes</span>
                                                </div>
                                                <!--end::Section-->
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="m-0">
                                                    <span
                                                        class="text-gray-800 fw-bolder d-block fs-2hx lh-1 ls-n2">345</span>
                                                    <span class="text-gray-400 fw-bold fs-6">Avarage
                                                        <br />Shares</span>
                                                </div>
                                                <!--end::Section-->
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="m-0">
                                                    <span
                                                        class="text-gray-800 fw-bolder d-block fs-2hx lh-1 ls-n2">3.5k</span>
                                                    <span class="text-gray-400 fw-bold fs-6">Avarage
                                                        <br />Comments</span>
                                                </div>
                                                <!--end::Section-->
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="m-0">
                                                    <span
                                                        class="text-gray-800 fw-bolder d-block fs-2hx lh-1 ls-n2">7.5k</span>
                                                    <span class="text-gray-400 fw-bold fs-6">Avarage
                                                        <br />Likes</span>
                                                </div>
                                                <!--end::Section-->
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="m-0">
                                                    <span
                                                        class="text-gray-800 fw-bolder d-block fs-2hx lh-1 ls-n2">9.1k</span>
                                                    <span class="text-gray-400 fw-bold fs-6">Avarage
                                                        <br />Likes</span>
                                                </div>
                                                <!--end::Section-->
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="m-0">
                                                    <span
                                                        class="text-gray-800 fw-bolder d-block fs-2hx lh-1 ls-n2">4.2k</span>
                                                    <span class="text-gray-400 fw-bold fs-6">Avarage
                                                        <br />Comments</span>
                                                </div>
                                                <!--end::Section-->
                                            ...
                                            <div class="d-flex flex-stack">
                                                ...
                                                <div class="m-0">
                                                    <span
                                                        class="text-gray-800 fw-bolder d-block fs-2hx lh-1 ls-n2">450</span>
                                                    <span class="text-gray-400 fw-bold fs-6">Avarage
                                                        <br />Shares</span>
                                                </div>
                                                <!--end::Section-->
                        ...
                        <div class="card card-flush h-lg-100">
                            ...
                            <div class="card-header py-7">
                                ...
                                <div class="card-title pt-3 mb-0 gap-4 gap-lg-10 gap-xl-15 nav nav-tabs border-bottom-0"
                                    ...
                                    <!--end::Tab item-->
                                    <!--begin::Tab item-->
                                    <div class="fs-4 fw-bolder text-muted pb-3 cursor-pointer"
                                        data-kt-table-widget-3="tab" data-kt-table-widget-3-value="Pending">Pending (8)
                                    </div>
                                    <!--end::Tab item-->
                                    <!--begin::Tab item-->
                                    <div class="fs-4 fw-bolder text-muted pb-3 cursor-pointer"
                                        data-kt-table-widget-3="tab" data-kt-table-widget-3-value="Completed">Completed
                                        (39)</div>
                                    <!--end::Tab item-->
                                </div>
                                <!--end::Tabs-->
                                ...
                                <div class="d-flex flex-stack flex-wrap gap-4">
                                    ...
                                    <div class="d-flex align-items-center gap-4">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                            data-kt-menu="true" id="kt_menu_6244460e3416a">
                                            <!--begin::Header-->
                                            <div class="px-7 py-5">
                                        ...
                                        <tr>
                                            <td class="min-w-175px">
                                                <div class="position-relative ps-6 pe-3 py-2">
                                                    ...
                                                    <a href="#"
                                                        class="mb-1 text-dark text-hover-primary fw-bolder">Cyber
                                                        Monday</a>
                                                    <div class="fs-7 text-muted fw-bolder">Created on 24 Dec 21</div>
                                                </div>
                                            </td>
