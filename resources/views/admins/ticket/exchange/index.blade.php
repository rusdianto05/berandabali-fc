                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="#" class="text-muted text-hover-primary">Penukaran Tiket</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">List Penukaran Tiket</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <script>
        $(document).ready(() => {
            var table = $('#table-ticket-match').DataTable({
                ...
                responsive: true,
                ajax: {
                    url: "{{ route('ticket-exchange.index') }}",
                    type: 'GET',
                },
                language: {
                    "paginate": {
